   ...
   <div class="navs">
        ...
        <div class="section session">
            <div class="section-title">
                <div class="title"> ورش العمل والجلسات </div>
            ...
            <div class="session-buttons">
                ...
                <div class="cards">
                    <div class="card">
                        ...
                        <div class="card-info">
                            <div class="information">
                                <div class="card-info-title">دعم نفسي وتعزيز
                                    الأمل</div>
                                <div class="card-info-disc">مساحة آمنة لمشاركة
                                    المشاعر
                                    وبناء
                                    القوة الداخلية</div>
                            </div>
                        ...
                        <div class="card-date">
                            <div class="date">
                                ...
                                <div class="date-quote-icon"><img
                                        ...
                                        alt="person-icon"> 5:00 م : 7:00 م</div>
                            </div>
                        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-info">
                            <div class="information">
                                <div class="card-info-title">ورشة التعبير الفني
                                    </div>
                                <div class="card-info-disc">  مساحة آمنة لمشاركة المشاعر وبناء القوة الداخلية 
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-info">
                            <div class="information">
                                <div class="card-info-title"> ورشة تنمية الذات والثقة
                                    </div>
                                <div class="card-info-disc">مساحة آمنة لمشاركة المشاعر وبناء القوة الداخلية
                         </div>
                            </div>
